...
public class LActivity extends AppCompatActivity {
    ...
    String Name, Password,Uid,Phone,address;
    Context ctx=this;
    ...
    public void main_reg(View v){
        Intent i=new Intent(LActivity.this,RegisterActivity.class);
        startActivity(i);
        ...
        protected void onPostExecute(String s) {
            ...
            else if((NAME.equals(Name))&&(PASSWORD.equals(Password)))
            {
                ...
                if (remember.isChecked()) {
                    ...
                    Intent myIntent = new Intent(LActivity.this, MainActivity.class);
