...
public class AdapterOStock extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterOStock(Context context, List<DataStock> data){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view=inflater.inflate(R.layout.container_ostock, parent,false);
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            String Sname=current.ShopName;
            Toast.makeText(context, "Shop="+Sname+"!!"+"Item="+name+"Id2="+id2, Toast.LENGTH_SHORT).show();
        ...
        class BackGround1 extends AsyncTask<String, String, String> {
            ...
            protected String doInBackground(String... params) {
                ...
                int tmp;
                try {
                    URL url = new URL("http://shopee.esy.es/BRAND/changeOStock.php");
